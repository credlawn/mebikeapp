...
class AccessoryDetailScreen extends ConsumerStatefulWidget {
  final Accessory item;
  const AccessoryDetailScreen({super.key, required this.item});

  @override
  ConsumerState<AccessoryDetailScreen> createState() => _AccessoryDetailScreenState();
}

class _AccessoryDetailScreenState extends ConsumerState<AccessoryDetailScreen> {
  late Accessory _item;
  ...
  Future<void> _toggleStatus() async {
    ...
    try {
      ...
      await ref.read(inventoryRepositoryProvider).updateAccessory(_item.id, {'status': newStatus});
