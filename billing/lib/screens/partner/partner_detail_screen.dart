                        ...
                        child: Column(
                          children: [
                            ...
                            _buildSection('Finance & Banking', [
                              ...
                              if (_partner!.legalName.isNotEmpty) _buildRow('Legal Name', _partner!.legalName),
                              if (_partner!.gstFilingType.isNotEmpty) _buildRow('GST Filing Type', _partner!.gstFilingType),
                              if (_partner!.stateCode.isNotEmpty) _buildRow('State Code', _partner!.stateCode),
                              if (_partner!.natureOfBusiness.isNotEmpty) _buildRow('Nature of Business', _partner!.natureOfBusiness),
                              if (_partner!.gstRegistrationDate != null) _buildRow('GST Reg Date', DateFormat('dd MMM yyyy').format(_partner!.gstRegistrationDate!)),
